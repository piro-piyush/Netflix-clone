                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            SizedBox(
                                              width: 260,
                                                child: Text(data[index].name,maxLines: 2,overflow: TextOverflow.ellipsis,))
                                          ],
                                        ),
                                      ),
                                    ));
                ...
                itemCount: searchModel?.results.length,
                  ...
                  itemBuilder: (context,index){
                    return Column(children: [
                      searchModel!.results[index].backdropPath == null? Image.asset("assets/netflix.png",height: 170,) :CachedNetworkImage(imageUrl: "$imageUrl${searchModel!.results[index].backdropPath },",height: 170,),
                      SizedBox(
                        width:100,
